<template>
  <div class="transaction-deposit">
    <el-card class="transaction-deposit-card">
      <template #header>
...
const submitForm = async () => {
  ...
  await formRef.value.validate(async (valid) => {
    if (valid && depositForm.accountId && depositForm.amount) {
      try {
        submitting.value = true
        
        // 调用真实API
        await accountApi.deposit(depositForm.accountId, depositForm.amount)
